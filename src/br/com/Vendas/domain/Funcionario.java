...
public class Funcionario {
	...
	@NotEmpty(message = "Insira o Registro")
	@Column(name = "fun_registro", length = 50, nullable = false)
	private String registro;
	
	@CPF(message = "CPF Incorreto Favor Digite Novamente")
	...
	public String toString() {
		return "Funcionario [codigo=" + codigo + ", nome=" + nome + ", registro=" + registro + ", cpf=" + cpf + ", senha=" + senha + ", funcao="
				+ funcao + "]";
	}
